in rust and async-graphql, how to resolve errors,

#Error
error[E0308]: mismatched types
   --> src/graphql/mutations/verify/otp_verification.rs:47:80
base32::decode(Alphabet::Rfc4648 { padding: true }, &user.secret)
